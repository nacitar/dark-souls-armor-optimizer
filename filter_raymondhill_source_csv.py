...
def filter_csv(
    ...
    with open(input_path, mode='r', newline='') as csvfile:
        ...
        field_names = sorted(reader.fieldnames) + [
                'weight_modifier', 'health_modifier',
                'stamina_modifier', 'stamina_regeneration']
...
if __name__ == '__main__':
    ...
    parser.add_argument('output_directory',
            help='The directory in which to place the results.')
    parser.add_argument('input_csv_path', help='The csv file to filter.')
    parser.add_argument('input_json_path', nargs='*',
            help='Extra json files to process.')
